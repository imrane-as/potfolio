...
const experiences = {
  en:[
    ...
    {period:"JAN 2024 — JUN 2024",company:"Capgemini",mark:"CG",logo:"https://cdn.simpleicons.org/capgemini",role:"DevOps Engineer / API Management",context:"Digital services · Software engineering",points:["Development of a centralized web application for purchase-contract management.","Design and development of business application features.","SQL Server database management.","Coordination with business users."],stack:[".NET","Entity Framework","Microsoft SQL Server"]},
